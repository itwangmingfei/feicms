<nav class="header" data-dir="#nav-{$list_dir}">
	<div class="navbar-header">
		<div class="container">
			...
			<a class="navbar-toggle primary-toggle visible-xs" href="javascript:;" data-toggle="owl" data-target="#navbar-primary"><i class="iconfont iconfont-menu">&#xe6a9;</i></a> <a class="navbar-toggle history-toggle visible-xs" href="javascript:;" data-toggle="owl" data-target="#history-dropdown"><i class="iconfont iconfont-history">&#xe64c;</i></a> <a class="navbar-toggle search-toggle visible-xs" href="{:ff_url('ajax/search')}"><i class="iconfont iconfont-search">&#xe679;</i></a> <a class="navbar-toggle navbar-goback" href="javascript:;"><i class="iconfont iconfont-back">&#xe608;</i></a>
		...
		<div class="navbar-primary" >
			<div class="container">
				<ul class="navbar-nav clearfix">
					...
					<li id="nav-{$nav_item.4.nav_tips}"><a href="{:ff_url_nav($nav_item[4]['nav_link'],$nav_item[5]['nav_tips'])}">{$nav_item.4.nav_title}</a></li>
					<li id="nav-{$nav_item.5.nav_tips}"><a href="{:ff_url_nav($nav_item[4]['nav_link'],$nav_item[5]['nav_tips'])}">{$nav_item.5.nav_title}</a></li>
				</ul>
			</div>
		</div>
