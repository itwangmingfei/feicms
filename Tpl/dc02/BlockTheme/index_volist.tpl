...
<div class="panel clearfix">
	...
	<div class="panel-aside">
		<ul class="rank-group clearfix">
			...
			<span class="rank-title"><a href="{:str_replace('video/ename/',$feifei['list_dir'].'/',ff_url_vod_read($feifei['list_id'],$feifei['list_dir'],$feifei['vod_id'],$feifei['vod_ename'],$feifei['vod_jumpurl']))}" title="{$feifei.vod_name}">{$feifei.vod_name}</a></span>
