...
<div class="panel">
	...
	<div class="search-hotkey">
		...
		<a class="btn btn-default btn-sm" href="{:str_replace('video/eplay/',$feifei['list_dir'].'/',ff_url_vod_play($feifei['list_id'],$feifei['list_dir'],$feifei['vod_id'],$feifei['vod_ename'],ff_array(ff_url_play_end($feifei['vod_url']),0),ff_array(ff_url_play_end($feifei['vod_url']),1)))}">{$feifei.vod_name|msubstr=0,15,'utf-8',true}</a>
		</volist>
	</div>
</div>
</div>
