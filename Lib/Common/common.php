...
function ff_player($array){
	...
	return '<script>var cms_player = '.json_encode($json).';</script>
		<script type="text/javascript" src="'.C('site_path').'Public/player/'.$json['name'].'.js"></script>';
